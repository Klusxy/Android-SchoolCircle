package com.oracle.schoolcircle.push;
...
//     private static final String MQTT_HOST = "172.20.10.7";
//     private static final String MQTT_HOST = "172.28.79.18";
//     private static final String MQTT_HOST = "192.168.1.101";
    ...
    private class MQTTConnection implements MqttSimpleCallback {
        ...
        public void publishArrived(String topicName, byte[] payload, int qos,
            ...
            String type = dataJSON.getString("message_type");
            if("message".equals(type)){
                String message_content = dataJSON.getString("message_content");
                String user_id = dataJSON.getString("user_id");
                String target_user_id = dataJSON.getString("target_user_id");
                String user_name = dataJSON.getString("user_name");
                String user_img = dataJSON.getString("user_img");
                String message_date = dataJSON.getString("message_date");
                String voice_time = dataJSON.getString("voice_time");
                MessageEntity messageEntity = new MessageEntity();
                messageEntity.setTarget_user_id(Integer.parseInt(target_user_id));
                messageEntity.setUser_id(Integer.parseInt(user_id));
                ...
                Log.d("mqtt","service接收到消息："+message_content);
                Intent intent = new Intent(ChatConstants.CHAT_MESSAGE);
                Bundle bundle = new Bundle();
                //传递实体类
                bundle.putSerializable("message",messageEntity);
                intent.putExtras(bundle);
                Log.d("mqtt","service准备发送广播");
